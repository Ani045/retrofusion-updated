...
document.addEventListener('DOMContentLoaded', function() {
  const forms = document.querySelectorAll('form[action="mail1.php"]');
  ...
  forms.forEach(function(form) {
    form.addEventListener('submit', function(e) {
      ...
      // Parse math equation from span
      const captchaInput = form.querySelector('input[name="captcha"]');
      if (captchaInput) {
        const span = captchaInput.previousElementSibling;
        if (span) {
      ...
      // Submit form using fetch in background (keepalive ensures it finishes even if page unloads)
      fetch('mail1.php', {
        method: 'POST',
      ...
      // Redirect instantly to thank-you.php
