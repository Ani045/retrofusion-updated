...
<section class="relative h-screen overflow-hidden">
    <video autoplay loop muted playsinline preload="auto" onloadeddata="this.play();"
        ...
        poster="https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863039/01_qwhl8a.jpg">
        <source
            src="https://res.cloudinary.com/dprafk917/video/upload/f_auto,q_auto/v1768241694/1874704f-2b23-41a2-aa21-ca77ce4aaecd_ipao9k.mp4"
            type="video/mp4" />
    </video>
    ...
    <div class="relative z-10 h-full flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <a href="https://www.airbnb.co.in/rooms/759365496263211635?locale=en&_set_bev_on_new_domain=1768230218_EAYTliZjZlOTUyNj&set_everest_cookie_on_new_domain=1768230218.EAODlhOWRiMDMwM2MwZT.Fby9Vq_Zkxe9N2U6b3exc6Pji4Mw2myla9vraPH5LDg&source_impression_id=p3_1771672171_P34foYseFvmlGSXI"
                target="_blank"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div class="grid grid-rows-2 gap-6">
                ...
                <div class="relative group overflow-hidden rounded-3xl">
                    <img loading="lazy" src="https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863047/29_qtp6zr.jpg"
...
<section class="py-12 md:py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-14">
            ...
            <p class="text-stone-600 font-light text-lg">Everything you need for a perfect stay</p>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10">
            ...
            <div class="text-center group">
                ...
                <h4 class="text-base font-semibold text-[#0F2A24] mb-1 font-display">Mesmerising Views</h4>
                <p class="text-sm text-stone-500">Mountain landscapes</p>
            </div>
            <!-- Item 2 -->
            <div class="text-center group">
                <div
                ...
                <h4 class="text-base font-semibold text-[#0F2A24] mb-1 font-display">Comfort & Luxury</h4>
                <p class="text-sm text-stone-500">Jacuzzi & steam bath</p>
            </div>
            <!-- Item 3 -->
            <div class="text-center group">
                <div
                ...
                <p class="text-sm text-stone-500">55" HDTV & games</p>
            </div>
            <!-- Item 4 -->
            <div class="text-center group">
                <div
                ...
                <h4 class="text-base font-semibold text-[#0F2A24] mb-1 font-display">Pet-Friendly</h4>
                <p class="text-sm text-stone-500">Pets welcome</p>
            </div>
            <!-- Item 5 -->
            <div class="text-center group">
                <div
                ...
                <h4 class="text-base font-semibold text-[#0F2A24] mb-1 font-display">Outdoor</h4>
                <p class="text-sm text-stone-500">Patio & BBQ grill</p>
            </div>
            <!-- Item 6 -->
            <div class="text-center group">
                <div
                ...
                <h4 class="text-base font-semibold text-[#0F2A24] mb-1 font-display">OTT Access</h4>
                <p class="text-sm text-stone-500">Netflix & more</p>
            </div>
            <!-- Item 7 -->
            <div class="text-center group">
                <div
                ...
                <h4 class="text-base font-semibold text-[#0F2A24] mb-1 font-display">Essentials</h4>
                <p class="text-sm text-stone-500">60 Mbps Wi-Fi</p>
            </div>
            <!-- Item 8 -->
            <div class="text-center group">
                <div
                ...
                <h4 class="text-base font-semibold text-[#0F2A24] mb-1 font-display">Safety</h4>
                <p class="text-sm text-stone-500">24/7 security</p>
            </div>
        </div>
    </div>
</section>
...
<section id="gallery" class="py-12 md:py-16 bg-[#F4EFEA]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-stone-600 font-light text-lg">A visual journey through your luxury retreat</p>
        </div>
        ...
        <div class="relative">
            <div id="bento-grid"
                ...
                <div class="relative overflow-hidden group cursor-pointer col-span-2 md:col-span-2 row-span-1 md:row-span-1 rounded-2xl shadow-lg hidden md:block"
                    ...
                    <img loading="lazy" src="https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863054/12_myvknr.jpg"
                        class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        alt="Villa View 2">
                    <div
                        class="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors duration-300 flex items-center justify-center">
                ...
                <div class="relative overflow-hidden group cursor-pointer col-span-1 md:col-span-1 row-span-1 md:row-span-1 rounded-2xl shadow-lg"
                    ...
                    <img loading="lazy" src="https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863051/07.1_u8yrn6.jpg"
                        class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        alt="Villa View 3">
                    <div
                        class="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors duration-300 flex items-center justify-center">
                ...
                <div class="relative overflow-hidden group cursor-pointer col-span-1 md:col-span-1 row-span-1 md:row-span-1 rounded-2xl shadow-lg"
                    ...
                    <img loading="lazy" src="https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863051/08.2_ws3oiy.jpg"
                        class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        alt="Villa View 4">
                    <div
                        class="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors duration-300 flex items-center justify-center">
...
<section class="py-12 md:py-16 bg-gradient-to-br from-stone-100 via-white to-amber-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-14">
            ...
            <p class="text-stone-600 font-light text-lg max-w-2xl mx-auto">Reserve your luxurious escape at
                Neo-Retro Villa. We'd love to host you.</p>
        </div>
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8 lg:p-10 border border-stone-200/50">
                ...
                <form action="mail1.php" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label
                                class="block text-xs font-semibold text-stone-700 mb-2 uppercase tracking-wide">Number
                                of Guests</label>
                            <select name="guests"
                                class="w-full px-4 py-3 text-sm border border-stone-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all outline-none bg-[#F4EFEA]/50 hover:bg-white">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label
                                class="block text-xs font-semibold text-stone-700 mb-2 uppercase tracking-wide">Check-in
                                Date</label>
                        ...
                        <div>
                            <label
                                class="block text-xs font-semibold text-stone-700 mb-2 uppercase tracking-wide">Check-out
                                Date</label>
                    ...
                    <div>
                        ...
                        <select name="villa"
                            ...
                            <option value="neo-retro" selected>Neo Retro</option>
                            <option value="retro-viswa">Retro Visawa</option>
                        </select>
                    </div>
                    <div>
                        <label
                            class="block text-xs font-semibold text-stone-700 mb-2 uppercase tracking-wide">Message</label>
                    ...
                    $num1_nr = rand(1, 10);
                    $num2_nr = rand(1, 10);
                    $_SESSION['captcha_answer'] = $num1_nr + $num2_nr;
                    ?>
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-4">
                            <span class="px-6 py-3 bg-[#F4EFEA] border border-stone-300 rounded-xl font-bold text-stone-900 text-lg">
                                <?php echo $num1_nr; ?> + <?php echo $num2_nr; ?> =
                            </span>
            ...
            <div class="space-y-6">
                <div class="bg-gradient-to-br from-stone-900 via-stone-800 to-stone-900 rounded-3xl p-8 shadow-2xl">
                    ...
                    <div class="mt-8 pt-6 border-t border-stone-700">
                        <p class="text-stone-400 text-sm italic">"Experience the perfect blend of luxury and
                            nature at Neo-Retro Villa"</p>
                    </div>
                </div>
                <div class="rounded-3xl overflow-hidden shadow-2xl border-4 border-white h-[280px] lg:h-[300px]">
                    <iframe
                        ...
                        referrerpolicy="no-referrer-when-downgrade" title="Neo Retro Location"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<section class="relative py-12 md:py-14 overflow-hidden">
    <div class="absolute inset-0">
        <img loading="lazy" src="https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863046/19_jxrtxx.jpg"
                ...
                <div class="space-y-3">
                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl border border-white/10 overflow-hidden">
                        <button onclick="toggleFAQ(this)"
                            ...
                            <h3 class="text-base font-medium text-white pr-4 font-display">What is Neo Retro
                                Villa?</h3>
                            <svg class="w-4 h-4 text-white/60 flex-shrink-0 transition-transform duration-200"
                        ...
                        <div class="faq-content h-0 overflow-hidden transition-all duration-200 opacity-0">
                            <p class="px-5 pb-4 text-stone-300 text-sm leading-relaxed">Neo-Retro Villa is an
                                artistic retreat that seamlessly blends art, luxury, and nature. It's a spacious
                                4 BHK villa in Lonavala with a swimming pool, designed for art lovers,
                                romantics, and those seeking a serene escape with boutique homestay experience
                                near Pune.</p>
                        </div>
                    </div>
                    <!-- FAQ Item 2 -->
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl border border-white/10 overflow-hidden">
                        <button onclick="toggleFAQ(this)"
                            class="w-full px-5 py-4 flex items-center justify-between text-left hover:bg-white/5 transition-colors">
                            <h3 class="text-base font-medium text-white pr-4 font-display">Where is Neo Retro
                                Villa located?</h3>
                            <svg class="w-4 h-4 text-white/60 flex-shrink-0 transition-transform duration-200"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="faq-content h-0 overflow-hidden transition-all duration-200 opacity-0">
                            <p class="px-5 pb-4 text-stone-300 text-sm leading-relaxed">Located in the serene
                                backdrop of Lonavala, Maharashtra, our villa is strategically positioned just
                                3.5 km from Kumar Resorts on Old Mumbai Pune Highway, offering easy access to
                                scenic wonders and historical sights.</p>
                        </div>
                    </div>
                    <!-- FAQ Item 3 -->
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl border border-white/10 overflow-hidden">
                        <button onclick="toggleFAQ(this)"
                            class="w-full px-5 py-4 flex items-center justify-between text-left hover:bg-white/5 transition-colors">
                            <h3 class="text-base font-medium text-white pr-4 font-display">What makes this villa
                                special?</h3>
                            <svg class="w-4 h-4 text-white/60 flex-shrink-0 transition-transform duration-200"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="faq-content h-0 overflow-hidden transition-all duration-200 opacity-0">
                            <p class="px-5 pb-4 text-stone-300 text-sm leading-relaxed">Our villa features an
                                artistically themed design with state-of-the-art amenities including swimming
                                pool, jacuzzi, steam bath, plunge pool, themed bedrooms, 55" HDTV with OTT
                                subscriptions, and mesmerising mountain views.</p>
                        </div>
                    </div>
                    <!-- FAQ Item 4 -->
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl border border-white/10 overflow-hidden">
                        <button onclick="toggleFAQ(this)"
                            class="w-full px-5 py-4 flex items-center justify-between text-left hover:bg-white/5 transition-colors">
                            <h3 class="text-base font-medium text-white pr-4 font-display">What are the check-in
                                and check-out times?</h3>
                            <svg class="w-4 h-4 text-white/60 flex-shrink-0 transition-transform duration-200"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                        ...
                        <div class="faq-content h-0 overflow-hidden transition-all duration-200 opacity-0">
                            <p class="px-5 pb-4 text-stone-300 text-sm leading-relaxed">Check-in is at 2:00 PM
                                and check-out is at 11:00 AM. We ensure a seamless experience with our dedicated
                                hospitality team.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="scroll-reveal-right">
                <div class="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/20">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-stone-300 text-sm">Experience luxury at Neo-Retro Villa</p>
                    </div>
                    <div class="flex flex-col items-center gap-2">
                        <a href="tel:+918999036644"
                            class="inline-flex items-center justify-center space-x-2 px-6 py-3 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white font-bold text-sm rounded-xl shadow-lg transition-all duration-300">
                        ...
                        <a href="contact.php"
                            class="inline-flex items-center justify-center space-x-2 px-6 py-3 bg-white/10 hover:bg-white/20 text-white font-semibold text-sm rounded-xl border border-white/30 transition-all duration-300">
                            <span>Send Enquiry</span>
                        </a>
                    </div>
                </div>
...
<section class="py-20 bg-[#0F2A24] relative overflow-hidden flex flex-col items-center justify-center">
    ...
    <div class="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div class="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-amber-900/10 blur-3xl">
        </div>
        <div class="absolute -bottom-[20%] -right-[10%] w-[50%] h-[50%] rounded-full bg-emerald-900/20 blur-3xl">
        </div>
    </div>
            ...
            <div class="relative w-[280px] sm:w-[320px] md:w-[360px] mx-auto md:mx-0 group mt-4 md:mt-0 flex-shrink-0">
                ...
                <div
                    ...
                    <div class="absolute top-2 inset-x-0 z-20 flex justify-center w-full">
                        <div
                            class="w-24 sm:w-28 h-6 sm:h-7 bg-black rounded-full flex items-center justify-between px-2">
                    ...
                    <!-- Phone Screen -->
                    <div class="w-full h-full bg-[#121212] relative rounded-[2rem] md:rounded-[2.2rem] overflow-x-hidden overflow-y-auto group/screen cursor-pointer hide-scrollbar-custom"
                        ...
                        <div class="pt-9 sm:pt-11 w-full flex flex-col items-center">
                            <a href="https://www.instagram.com/retrofusion.in/" target="_blank" class="w-full">
                                <img loading="lazy" src="https://res.cloudinary.com/damfndmrm/image/upload/f_auto,q_auto/v1772471878/Screenshot_2026-03-02_at_10.47.42_PM_wo3toj.png"
            ...
            <div class="hidden md:grid grid-cols-2 gap-6 w-full max-w-[540px]">
                ...
                <a href="https://www.instagram.com/retrofusion.in/" target="_blank"
                    ...
                    <div
                        ...
                        <div class="mx-2.5 mb-2 border-[3px] border-amber-600 rounded-lg overflow-hidden">
                            <img loading="lazy" src="https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1772473164/Screenshot_2026-03-02_at_11.08.01_PM_a5g0vs.png"
                                alt="Instagram Post"
                        ...
                        <div class="px-3 pb-2.5">
                            <div class="flex items-center justify-between mb-1.5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <svg class="w-5 h-5 text-[#0F2A24]" fill="none" stroke="currentColor"
                                    ...
                                    <svg class="w-5 h-5 text-[#0F2A24]" fill="none" stroke="currentColor"
                                        stroke-width="2" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M12 19l9-7-9-7v14zM3 12l9-7v14l-9-7z" />
                                    </svg>
                                </div>
                ...
                <a href="https://www.instagram.com/retrofusion.in/" target="_blank"
                    ...
                    <div
                        ...
                        <div class="mx-2.5 mb-2 border-[3px] border-amber-600 rounded-lg overflow-hidden">
                            <img loading="lazy" src="https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1772473164/Screenshot_2026-03-02_at_11.07.23_PM_sbgs0f.png"
                                alt="Instagram Post"
                                class="w-full aspect-square object-cover transition-transform duration-700 group-hover:scale-105" />
                        </div>
                        <div class="px-3 pb-2.5">
                ...
                <a href="https://www.instagram.com/retrofusion.in/" target="_blank"
                    ...
                    <div
                        ...
                        <div class="mx-2.5 mb-2 border-[3px] border-amber-600 rounded-lg overflow-hidden">
                            <img loading="lazy" src="https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1772473163/Screenshot_2026-03-02_at_11.07.36_PM_ftkdee.png"
                                alt="Instagram Post"
                                class="w-full aspect-square object-cover transition-transform duration-700 group-hover:scale-105" />
                        </div>
                        <div class="px-3 pb-2.5">
                ...
                <a href="https://www.instagram.com/retrofusion.in/" target="_blank"
                    ...
                    <div
                        ...
                        <div class="mx-2.5 mb-2 border-[3px] border-amber-600 rounded-lg overflow-hidden">
                            <img loading="lazy" src="https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1772473163/Screenshot_2026-03-02_at_11.07.51_PM_yzseuz.png"
                                alt="Instagram Post"
                                class="w-full aspect-square object-cover transition-transform duration-700 group-hover:scale-105" />
                        </div>
                        <div class="px-3 pb-2.5">
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "thumbnailUrl": "https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863039/01_qwhl8a.jpg",
      "uploadDate": "2024-01-01T08:00:00+08:00",
      "contentUrl": "https://res.cloudinary.com/dprafk917/video/upload/f_auto,q_auto/v1768241694/1874704f-2b23-41a2-aa21-ca77ce4aaecd_ipao9k.mp4"
    }
  ]
}
</script>
...
<div id="lightbox"
    ...
    <img loading="lazy" id="lightbox-img" src="" alt="Gallery"
...
<script>
    window.galleryImages = [
        ...
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863054/12_myvknr.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863051/07.1_u8yrn6.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863051/08.2_ws3oiy.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863047/29_qtp6zr.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863047/20_haycpz.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863046/19_jxrtxx.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863045/18_xqydeo.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863044/14_w8imzc.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863043/08.1_cth2qs.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863043/09_ufowaj.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863041/04_s8l8dy.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863040/07_jrnhvd.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863040/05_sty1kz.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863039/01_qwhl8a.jpg',
        'https://res.cloudinary.com/dprafk917/image/upload/f_auto,q_auto/v1769863039/06_mk52qt.jpg',
    ];
    ...
    window.gallerySets = [
        ...
        [window.galleryImages[8], window.galleryImages[9], window.galleryImages[0], window.galleryImages[1]]
    ];
</script>
