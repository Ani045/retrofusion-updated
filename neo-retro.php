<?php
$pageTitle = "Neo-Retro Villa - Artistic Luxury Stay in Khandala | Retrofusion";
$pageDescription = "";
...
?>
        ...
        <section class="relative h-screen overflow-hidden">
            <video autoplay loop muted playsinline preload="auto" onloadeddata="this.play();"
                ...
                poster="https://res.cloudinary.com/dprafk917/image/upload/v1769863039/01_qwhl8a.jpg">
                <source
                    src="https://res.cloudinary.com/dprafk917/video/upload/v1768241694/1874704f-2b23-41a2-aa21-ca77ce4aaecd_ipao9k.mp4"
                    type="video/mp4" />
            </video>
                ...
                <div class="max-w-4xl mx-auto text-center">
                    <div class="space-y-4 sm:space-y-6 mb-8">
                        <h1
                            ...
                            Neo-Retro Villa</h1>
                        <p
                            class="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 font-light max-w-2xl mx-auto">
                            Luxurious 4 BHK Villa in Lonavala with Swimming Pool</p>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-10 md:mb-14">
                    ...
                    <div class="flex items-center">
                        <p class="text-stone-600 text-base md:text-lg leading-relaxed">Experience Retrofusion's crown
                            jewel <span class="font-bold text-stone-800">a 4 BHK Villa in Lonavala</span>
                            that doubles as a private art gallery. Every space features original art, making it a
                            truly immersive Boutique homestay near Pune for creative souls.<br>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <div class="grid grid-rows-2 gap-6">
                        ...
                        <div class="relative group overflow-hidden rounded-3xl">
                            <img src="https://res.cloudinary.com/dprafk917/image/upload/v1769863047/29_qtp6zr.jpg"
        ...
        <section class="py-12 md:py-16 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-14">
                    <h2
                        class="text-3xl sm:text-4xl md:text-5xl font-bold text-[#0F2A24] leading-tight mb-4 font-display">
                ...
                <div class="relative">
                    <div id="bento-grid"
                        ...
                        <div class="relative overflow-hidden group cursor-pointer col-span-2 md:col-span-2 row-span-1 md:row-span-1 rounded-2xl shadow-lg hidden md:block"
                            ...
                            <img src="https://res.cloudinary.com/dprafk917/image/upload/v1769863054/12_myvknr.jpg"
                                class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                                alt="Villa View 2">
                            <div
                                class="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors duration-300 flex items-center justify-center">
                        ...
                        <div class="relative overflow-hidden group cursor-pointer col-span-1 md:col-span-1 row-span-1 md:row-span-1 rounded-2xl shadow-lg"
                            ...
                            <img src="https://res.cloudinary.com/dprafk917/image/upload/v1769863051/07.1_u8yrn6.jpg"
                                class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                                alt="Villa View 3">
                            <div
                                class="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors duration-300 flex items-center justify-center">
                        ...
                        <div class="relative overflow-hidden group cursor-pointer col-span-1 md:col-span-1 row-span-1 md:row-span-1 rounded-2xl shadow-lg"
                            ...
                            <img src="https://res.cloudinary.com/dprafk917/image/upload/v1769863051/08.2_ws3oiy.jpg"
                                class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                                alt="Villa View 4">
                            <div
                                class="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors duration-300 flex items-center justify-center">
        ...
        <section class="py-12 md:py-16 bg-gradient-to-br from-stone-100 via-white to-amber-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    <div class="bg-white rounded-3xl shadow-2xl p-8 lg:p-10 border border-stone-200/50">
                        ...
                        <form class="space-y-5">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label
                                        class="block text-xs font-semibold text-stone-700 mb-2 uppercase tracking-wide">Full
                                        Name *</label>
                                ...
                                <div>
                                    <label
                                        class="block text-xs font-semibold text-stone-700 mb-2 uppercase tracking-wide">Email
                                        Address *</label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label
                                        class="block text-xs font-semibold text-stone-700 mb-2 uppercase tracking-wide">Phone
                                        Number</label>
                            ...
                            <div>
                                <label
                                    class="block text-xs font-semibold text-stone-700 mb-2 uppercase tracking-wide">Preferred
                                    Villa</label>
                                <select name="villa"
                                    class="w-full px-4 py-3 text-sm border border-stone-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all outline-none bg-[#F4EFEA]/50 hover:bg-white">
                    ...
                    <div class="space-y-6">
                        <div
                            class="bg-gradient-to-br from-stone-900 via-stone-800 to-stone-900 rounded-3xl p-8 shadow-2xl">
                            ...
                            <div class="space-y-5">
                                <a href="tel:+918999036644" class="flex items-center gap-4 group">
                                    ...
                                    <div>
                                        ...
                                        <p
                                            class="text-white font-medium text-lg group-hover:text-amber-300 transition-colors">
                                            +91 89990 36644</p>
                                    </div>
                                </a>
                        ...
                        <div
                            class="rounded-3xl overflow-hidden shadow-2xl border-4 border-white h-[280px] lg:h-[300px]">
                            <iframe
        ...
        <section class="relative py-12 md:py-14 overflow-hidden">
            <div class="absolute inset-0">
                <img src="https://res.cloudinary.com/dprafk917/image/upload/v1769863046/19_jxrtxx.jpg"
        ...
        <section class="py-20 bg-[#0F2A24] relative overflow-hidden flex flex-col items-center justify-center">
            ...
            <div class="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                ...
                <div
                    class="absolute -bottom-[20%] -right-[10%] w-[50%] h-[50%] rounded-full bg-emerald-900/20 blur-3xl">
                </div>
            </div>

            <div
                class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center w-full">
                <!-- Title -->
                ...
                <!-- Main Content Area -->
                <div
                    class="flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-20 w-full max-w-6xl mx-auto">
                    <!-- Phone Mockup Container (Left on Desktop, Center on Mobile) -->
                    <div
                        class="relative w-[280px] sm:w-[320px] md:w-[360px] mx-auto md:mx-0 group mt-4 md:mt-0 flex-shrink-0">
                            ...
                            <div class="w-full h-full bg-[#121212] relative rounded-[2rem] md:rounded-[2.2rem] overflow-x-hidden overflow-y-auto group/screen cursor-pointer hide-scrollbar-custom"
                                ...
                                <div class="pt-9 sm:pt-11 w-full flex flex-col items-center">
                                    <a href="https://www.instagram.com/retrofusion.in/" target="_blank" class="w-full">
                                        <img src="https://res.cloudinary.com/damfndmrm/image/upload/v1772471878/Screenshot_2026-03-02_at_10.47.42_PM_wo3toj.png"
                    ...
                    <div class="hidden md:grid grid-cols-2 gap-6 w-full max-w-[540px]">
                        ...
                        <a href="https://www.instagram.com/retrofusion.in/" target="_blank"
                            ...
                            <div
                                ...
                                <div class="mx-2.5 mb-2 border-[3px] border-amber-600 rounded-lg overflow-hidden">
                                    <img src="https://res.cloudinary.com/dprafk917/image/upload/v1772473164/Screenshot_2026-03-02_at_11.08.01_PM_a5g0vs.png"
                                        alt="Instagram Post"
                        ...
                        <a href="https://www.instagram.com/retrofusion.in/" target="_blank"
                            ...
                            <div
                                ...
                                <div class="mx-2.5 mb-2 border-[3px] border-amber-600 rounded-lg overflow-hidden">
                                    <img src="https://res.cloudinary.com/dprafk917/image/upload/v1772473164/Screenshot_2026-03-02_at_11.07.23_PM_sbgs0f.png"
                                        alt="Instagram Post"
                                        class="w-full aspect-square object-cover transition-transform duration-700 group-hover:scale-105" />
                                </div>
                                <div class="px-3 pb-2.5">
                        ...
                        <a href="https://www.instagram.com/retrofusion.in/" target="_blank"
                            ...
                            <div
                                ...
                                <div class="mx-2.5 mb-2 border-[3px] border-amber-600 rounded-lg overflow-hidden">
                                    <img src="https://res.cloudinary.com/dprafk917/image/upload/v1772473163/Screenshot_2026-03-02_at_11.07.36_PM_ftkdee.png"
                                        alt="Instagram Post"
                                        class="w-full aspect-square object-cover transition-transform duration-700 group-hover:scale-105" />
                                </div>
                                <div class="px-3 pb-2.5">
                        ...
                        <a href="https://www.instagram.com/retrofusion.in/" target="_blank"
                            ...
                            <div
                                ...
                                <div class="mx-2.5 mb-2 border-[3px] border-amber-600 rounded-lg overflow-hidden">
                                    <img src="https://res.cloudinary.com/dprafk917/image/upload/v1772473163/Screenshot_2026-03-02_at_11.07.51_PM_yzseuz.png"
                                        alt="Instagram Post"
                                        class="w-full aspect-square object-cover transition-transform duration-700 group-hover:scale-105" />
                                </div>
                                <div class="px-3 pb-2.5">
...
<?php include 'includes/footer.php'; ?>
        ...
        <div id="lightbox"
            ...
            <div
                class="absolute bottom-4 left-1/2 -translate-x-1/2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
