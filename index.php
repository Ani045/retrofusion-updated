...
?>
    ...
    <section id="hero-section" class="relative h-screen flex items-center justify-center overflow-hidden touch-pan-y">
      <div class="absolute inset-0 w-full h-full">
        ...
        <div id="hero-prev-layer" class="hero-image-layer" style="z-index:2;display:none;"><img id="hero-prev-img"
            src="" alt="Retrofusion Homestay" /></div>
      ...
      <div class="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 animate-fade-in"
    ...
    <!-- ===== FEATURED PROPERTIES ===== -->
    <section id="villas-section"
      class="py-8 bg-gradient-to-br from-stone-50 via-amber-50/30 to-stone-100 scroll-reveal">
            ...
            <div class="grid grid-cols-4 sm:grid-cols-5 gap-x-2 gap-y-6 sm:gap-x-4 lg:gap-x-6 lg:gap-y-8">
              ...
              <div class="flex flex-col items-center text-center">
                <div class="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 mb-2 sm:mb-3">
                  <img
                    src="https://res.cloudinary.com/dprafk917/image/upload/v1771063573/Private_Luxury_Villas_u4cgeg.png"
              ...
              <div class="flex flex-col items-center text-center">
                <div class="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 mb-2 sm:mb-3">
                  <img
                    src="https://res.cloudinary.com/dprafk917/image/upload/v1771063565/Private_Pool_Jacuzzi_j0gah4.png"
    ...
    <section
      ...
      <div class="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          class="absolute top-0 right-0 w-[700px] h-[700px] bg-amber-500/[0.04] rounded-full blur-[180px] -mr-64 -mt-64">
        </div>
        <div
          ...
          <div>
            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              ...
              <div class="space-y-3">
                ...
                <a href="https://wa.me/918999036644" target="_blank"
